        ...
        <form onSubmit={submitLoginHandler}>
            <div className="inner-form">
                ...
                <div className="form-input">
                    ...
                    <input type="text" name="login" id="login" onChange={ev => setLogin(ev.target.value)} value={login} maxLength="30" />
                </div>

                <div className="form-input">
                    <label htmlFor="password">Password:</label>
                    <input type="password" name="password" id="password" onChange={ev => setPassword(ev.target.value)} value={password} maxLength="30" />
                </div>
